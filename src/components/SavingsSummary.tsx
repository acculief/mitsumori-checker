    ...
    <div className="animate-fade-in-up-delay-1">
      <div className="grid grid-cols-3 gap-2">
        <div className="rounded-lg bg-white border border-slate-200 p-3 text-center">
          <div className="text-[11px] font-medium text-slate-500 mb-0.5">診断項目</div>
        ...
        <div className="rounded-lg bg-white border border-slate-200 p-3 text-center">
          <div className="text-[11px] font-medium text-slate-500 mb-0.5">割安・適正</div>
        ...
        <div className="rounded-lg bg-white border border-slate-200 p-3 text-center">
          <div className="text-[11px] font-medium text-slate-500 mb-0.5">要確認</div>
